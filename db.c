...
void initialize_internal_node(void *node)
{
    ...
    set_node_root(node, false);
    *leaf_node_num_cells(node) = 0;
    *internal_node_next_leaf(node) = 0; // 0 represents no right sibling
}
...
// Function to execute insert statement
